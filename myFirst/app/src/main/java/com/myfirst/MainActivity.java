    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        b.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                TextView t = (TextView) findViewById(R.id.getEntry3);
                t.setText("SUCCESS");
                try {
...
//                        }
            ...
            protected Map<String, String> getParams() {
                Map<String, String> params = new HashMap<String, String>();
                params.put("teamname",getResources().getString(R.string.valTeamName));
                params.put("entry1",getResources().getString(R.string.valEntry1));
                params.put("name1",getResources().getString(R.string.valName1));
                params.put("entry2",getResources().getString(R.string.valEntry2));
                params.put("name2",getResources().getString(R.string.valName2));
                params.put("entry3",getResources().getString(R.string.valEntry3));
                params.put("name3", getResources().getString(R.string.valName3));
